...
if (($_SESSION['l']=='Admin') && ($_SESSION['p']=='123')) 
{ 
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li style="margin-left: calc(50% - 100px);" class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>ajouter Promotion</a></li>
                                </ul>
                     ...
                     <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li style="margin-left: calc(50% - 100px);" class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>Modifier promotion</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
...
if (($_SESSION['l']=='Client') && ($_SESSION['p']=='bbb')) 
 {
