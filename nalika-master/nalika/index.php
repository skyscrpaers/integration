                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                                                <li><a title="Commande" href="index-1.php"><span class="mini-sub-pro">Liste de Commandes</span></a></li>
    ...
    <script>
      window.onload = function() {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
          ...
          title: {
            text: "Statistique des publicites et des prommotions "
          },
          data: [{
