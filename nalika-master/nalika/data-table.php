          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="sparkline13-list">
              <div class="sparkline13-hd">
                  <input type="text" placeholder="Search for names.." onkeyup="myFunction()" class="form-control" id="myInput" >
              </div>
              <div class="sparkline13-graph">
                <div class="datatable-dashv1-list custom-datatable-overright">

              <?php include"afficherClient.php"; ?>
              <br>
              <form action="imprimerlisteclient.php" method="post">
                <input type="submit" name="" value="Exporter Comme PDF">
              </form>
                </div>
              </div>
              <script>
