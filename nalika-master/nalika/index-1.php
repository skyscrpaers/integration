...
<body>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Welcome to Skyskypers <span class="bread-ntd">Admin Template</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
  ...
  <h4>Liste des commandes</h4>
																	...
																	<th>nbr</th>
																	<th>etatCmd</th>
																	  <th onclick="sortTable(2)">Edit</th>
																	<th>Delete</th>
																	<th>
                            ...
                            <div class="custom-pagination">
								<ul class="pagination">
									...
									<li class="page-item"><a class="page-link" href="commande-edit.php">1</a></li>
