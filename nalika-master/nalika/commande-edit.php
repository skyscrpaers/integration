<?php require_once ("../../core/CommandeC.php");
 ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <form method="POST" action="modifiere.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                  ...
                                                  if(isset($_POST['id']))
                                                  {
                                                   $liste = CommandeC::recuperercommande($_POST['id']);
                                                  }
                                                  else
                                                  {
                                                    $liste['idcommande']="idcommande";
                                                    $liste['dateCmd']="pas d'article a éditer";
                                                    $liste['idClient']="pas d'article a éditer";
                                                    $liste['totale']="pas d'article a éditer";
                                                    $liste['nbr']="pas d'article a éditer";
                                                    $liste['etatCmd']="etatCmd";
                                                  }
                                                    ?>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                       <?php echo '<input type="text" class="form-control" placeholder="'.$liste['idcommande'].'" required pattern="[A-Za-z0-9'.']'.'{1,}'.'" name="id" title="id">';?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                       <?php echo'<input type="text" name="nom" class="form-control" placeholder="'.$liste['etatCmd'].'" required pattern="[A-Za-z0-9]{1,}">';?>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <?php echo'<button type="submit" name="id" type="button" value="'.$liste['idcommande'].'" class="btn btn-ctl-bt waves-effect waves-light m-r-10"value="Save">Enregistrer</button>'?>
