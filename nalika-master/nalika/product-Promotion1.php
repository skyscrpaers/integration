...
<body>
        ...
        <nav id="sidebar" class="">
            ...
            <div class="nalika-profile">
                <div class="profile-dtl">
                    <a href="../../web/index.php"><img src="img/notification/dali.jpg" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="statistique2" href="statistique1.php"><span class="mini-sub-pro">Statistique1</span></a></li>
 ...
 <li><a title="Product Cart" href="list_promotion.php"><span class="mini-sub-pro">List Promotion</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-table icon-wrap"></i> <span class="mini-click-non">Les Utilisateurs</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Peity Charts" href="cards.php"><span class="mini-sub-pro">Cards</span></a></li>
                                <li><a title="Data Table" href="data-table.php"><span class="mini-sub-pro">Users</span></a></li>
                            </ul>
                        </li>
                        <li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                               ...
                                               <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Reférence" id="Pref"name="Pref" autocomplete="off" pattern="[0-9]{1,}" required>
                                                    </div>
                                               <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div style="margin-top: 0px;" class="review-content-section">
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
                                                        ...
                                                        $sql= 'SELECT ref,nom FROM produit ORDER BY  ref';
                                                        $db = config::getConnexion();
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
                                                            <?php foreach($db->query($sql) as $row)
                                                            {
                                                                echo'<option value="'.$row['ref'].'">'.$row['nom'].'</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                                           <?php
                                                    
                                                        $sql= 'SELECT ref FROM produit ORDER BY  ref';
                                                        $db = config::getConnexion();
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
                                                        ...
                                                        $sql= 'SELECT ref,prix FROM produit ORDER BY  ref';
                                                        $db = config::getConnexion();
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
                                                            <?php foreach($db->query($sql) as $row)
                                                            {
                                                                echo'<option value="'.$row['ref'].'">'.$row['prix'].'</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                     <div style="margin-top: 10px;" class="review-content-section">
