...
<body>
	...
	{?>
							...
							<div class="sap_tabs">
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
										...
										<div class="facts">
											<div class="register">
												<form action="Login.php" method="post">
													...
													<input name="mdp" placeholder="Password" type="password" required="">
													<div class="sign-up">
									...
									<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="facts">
											<div class="register">
												<form name="f" action="ajouterClient.php" method="post">
													<input placeholder="Votre nom" name="nom" type="text" required="">
													<input placeholder="Votre prenom" name="prenom" type="text" style="margin: 14px 0 0 0;" required="">
													<input placeholder="Adresse E-mail" name="email" type="email" required="">
													<input placeholder="Date De Naissance" name="date" type="date" required="" style="    outline: none;
	    ...
	    font-size: 14px;
			margin: 14px 0 0 0;">
													<input placeholder="Mot De Passe" name="mdp" type="password" required="" id="mdpv">
													<input placeholder="Confirmer Mot De Passe" name="mdp2" type="password" required="" id="mdp2v">
													<table style="margin-top: 14px;">
														<tr>
															<td><label>+216</label></td>
															<td width="100%"><input placeholder="Numéro De Telephone" name="numtel" type="text" required="" id="numtelv"></td>
														</tr>
													</table>
													<br>
													...
													<div class="sign-up">
														<input type="submit" value="Create Account" id="bouton">
													</div>
												</form>
											</div>
										</div>
...
?>
				...
				<div class="w3agile_special_deals_grid_left_grid">
				<?php
$sql='SELECT id,image FROM file_img where id ="2"';
		$db = config::getConnexion();
				foreach  ($db->query($sql) as $row)
				{
