	...
	function afficherCollectionF()
	{
		...
		$db = config::getConnexion();
				...
				<div class="swiper-image">
					<button classe="id_ca" onclick="showpic(this.id)"; style="border:none;background-color:transparent;" type="submit" name="send" id="'.$row['id'].'" value="'.$row['id'].'"><img src="../nalika-master/nalika/images/'. $row['image'] .'"></button>
				</div>
			</div>'; 			
				}
