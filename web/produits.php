			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<!-- Mega Menu -->
						<li >
							<a href="categories.php"  >Categories <b ></b></a>
			...
			<div class="w3ls_mobiles_grids">
				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
								...
								include"config.php";
								$cat=$_GET['cat'];
								$sql =  'SELECT * FROM produit WHERE id_ca = '.$cat.'';
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							...
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="<?PHP echo '../nalika-master/nalika/image/'. $row['image']; ?>" alt=" " class="img-responsive" >
								...
								<div class="simpleCart_shelfItem">
									<p> <i class="item_price"><?PHP echo $row['prix'] .' DT'; ?></i></p>
									<!--<h5><?PHP echo $row['description']; ?></h5> -->
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
										<input type="hidden" name="add" value="1" /> 
										<input type="hidden" name="w3ls_item" value="<?PHP echo$row['nom']; ?>" /> 
										<input type="hidden" name="amount" value="<?PHP echo$row['prix'] .' DT'; ?>"/> 
									
										<a href="addcart.php?reference=<?PHP echo $row['ref']; ?>"><input type="button" value="Add to cart" class="w3ls-cart"></a>  
									</form>
								</div> 
